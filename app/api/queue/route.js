...
function finishEventToUnregisteredRun(event, matchCandidates = [], youtubeCandidates = []) {
  ...
  return {
    ...
    result: reparsedEvent.result || "unknown",
    resultEvidence: reparsedEvent.resultEvidence || "unknown",
    resultSemanticsVersion: reparsedEvent.resultSemanticsVersion || "",
    explicitWinnerVariant: reparsedEvent.explicitWinnerVariant || "",
    highestShareVariant: "",
    operationalDecision: "",
    youtubeAppliedVariant: "",
    inconclusiveReason: reparsedEvent.inconclusiveReason || "",
    inconclusiveReasonEvidence: reparsedEvent.inconclusiveReasonEvidence || "",
    signalResolution: {
