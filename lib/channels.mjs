export const CHANNEL_PRIORITY = ["Jotform", "AI Agents Podcast", "AI Agents"];
...
export function canonicalChannelName(value) {
  ...
  if (hasChannelWord(raw, "apps") || hasChannelWord(compact, "apps")) {
    return "Apps";
  }
  if (hasChannelWord(raw, "sign") || hasChannelWord(compact, "sign")) {
    return "Sign";
  }
