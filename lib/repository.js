  ...
  await sql.query(
    `
      ...
      INSERT INTO test_runs (
        test_run_id, test_id, content_hash, video_id, source_kind, source_tab_mode, spreadsheet_id, sheet_name, row_number,
      ...
      SELECT
        test_run_id, NULLIF(test_id, ''), content_hash, video_id, source_kind, source_tab_mode, spreadsheet_id, sheet_name, row_number,
  ...
  const rows = await sql.query(
    `
      ...
      WHERE run.source_kind = policies.source_kind
        ...
        AND LOWER(TRIM(run.sheet_name)) = LOWER(TRIM(policies.sheet_name))
