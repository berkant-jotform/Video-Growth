        ...
        SET possible_retest = EXISTS (
          ...
          WHERE other.video_id = current.video_id
            ...
            AND (
              ...
              OR other.spreadsheet_id IS DISTINCT FROM current.spreadsheet_id
              OR other.sheet_name IS DISTINCT FROM current.sheet_name
              OR other.row_number IS DISTINCT FROM current.row_number
            )
        )
