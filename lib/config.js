...
export async function getAppConfig() {
  ...
  return {
    ...
    extensionRuntimeConfig: parseExtensionRuntimeConfigJson(settings[EXTENSION_RUNTIME_CONFIG_KEY].value),
    extensionRuntimeConfigJson: JSON.stringify(parseExtensionRuntimeConfigJson(settings[EXTENSION_RUNTIME_CONFIG_KEY].value), null, 2),
