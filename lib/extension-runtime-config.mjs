...
export function normalizeExtensionRuntimeConfig(input = {}) {
  ...
  return {
    ...
    passiveScanMinutes: clampNumber(safe.passiveScanMinutes, 15, 240, DEFAULT_EXTENSION_RUNTIME_CONFIG.passiveScanMinutes),
    commandPollMinutes: clampNumber(safe.commandPollMinutes, 1, 15, DEFAULT_EXTENSION_RUNTIME_CONFIG.commandPollMinutes),
    startupCatchupMinutes: clampNumber(safe.startupCatchupMinutes, 5, 120, DEFAULT_EXTENSION_RUNTIME_CONFIG.startupCatchupMinutes),
    ...
    accessibleLabelsEnabled: safe.accessibleLabelsEnabled !== false,
