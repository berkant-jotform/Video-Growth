...
export function matchFinishEventToRun(event, activeRuns = []) {
  ...
  for (const run of activeRuns) {
    ...
    const channelMatches = Boolean(normalizedEventChannel && runChannel && normalizedEventChannel === runChannel);
    const channelMismatch = Boolean(normalizedEventChannel && runChannel && normalizedEventChannel !== runChannel);
